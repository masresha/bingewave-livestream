...
(function (angular) {
    angular
        ...
        .controller('ContentHomeCtrl', ['$scope','$location', 'SocialDataStore','ReqService','ApService', 'Modals', 'Buildfire', 'EVENTS', '$timeout', 'SocialItems', 'Util',
         function ($scope, $location, SocialDataStore,ReqService,ApService, Modals, Buildfire, EVENTS, $timeout, SocialItems, Util) {
                ...
                result) {
                    ...
                    ApService.get_distributor_token(credentials, function (
                        result) {
                            ...
                            ContentHome.template_id = "396a4882-1ad0-4d5c-ba11-c264c244e1bb";
                            ...
                            ContentHome.data.content.template_id  = "396a4882-1ad0-4d5c-ba11-c264c244e1bb";
